...
external open class DayOfWeek : Temporal {
    ...
    open fun compareTo(other: DayOfWeek): Number = definedExternally
...
external open class SignStyle {
    companion object {
        var NORMAL: SignStyle = definedExternally
        var NEVER: SignStyle = definedExternally
        var ALWAYS: SignStyle = definedExternally
        var EXCEEDS_PAD: SignStyle = definedExternally
        var NOT_NEGATIVE: SignStyle = definedExternally
    }
}
external open class DateTimeFormatter {
    ...
    open fun withLocale(locale: Locale): DateTimeFormatter = definedExternally
...
external open class DateTimeFormatterBuilder {
    ...
    open fun appendValue(field: TemporalField, width: Number? = definedExternally /* null */, maxWidth: Number? = definedExternally /* null */, signStyle: SignStyle? = definedExternally /* null */): DateTimeFormatterBuilder = definedExternally
    open fun appendValueReduced(field: TemporalField, width: Number, maxWidth: Number, base: Number): DateTimeFormatterBuilder = definedExternally
    open fun appendValueReduced(field: TemporalField, width: Number, maxWidth: Number, base: ChronoLocalDate): DateTimeFormatterBuilder = definedExternally
...
external open class Month : Temporal {
    open fun adjustInto(temporal: Temporal): Temporal = definedExternally
    open fun compareTo(other: Month): Number = definedExternally
    open fun equals(other: Month): Boolean = definedExternally
    ...
    companion object {
        ...
        fun valueOf(name: String): Month = definedExternally
...
external open class ChronoUnit : TemporalUnit {
    ...
    override fun toString(): String = definedExternally
    companion object {
        var NANOS: ChronoUnit = definedExternally
...
external open class ZoneOffset : ZoneId {
    ...
    open fun getLong(field: TemporalField): Number = definedExternally
    override fun hashCode(): Number = definedExternally
    override fun id(): String = definedExternally
    open fun query(query: TemporalQuery): Any = definedExternally
...
external open class ZoneOffsetTransition {
    ...
    open fun dateTimeBefore(): LocalDateTime = definedExternally
    open fun dateTimeAfter(): LocalDateTime = definedExternally
    open fun offsetBefore(): ZoneOffset = definedExternally
    open fun offsetAfter(): ZoneOffset = definedExternally
    open fun duration(): Duration = definedExternally
    open fun durationSeconds(): Number = definedExternally
    open fun isGap(): Boolean = definedExternally
    open fun isOverlap(): Boolean = definedExternally
    open fun isValidOffset(offset: ZoneOffset): Boolean = definedExternally
    open fun validOffsets(): Array<ZoneOffset> = definedExternally
    open fun compareTo(transition: ZoneOffsetTransition): Number = definedExternally
    override fun equals(other: Any?): Boolean = definedExternally
    override fun hashCode(): Number = definedExternally
    override fun toString(): String = definedExternally
    companion object {
        fun of(transition: LocalDateTime, offsetBefore: ZoneOffset, offsetAfter: ZoneOffset): ZoneOffsetTransition = definedExternally
    }
}
...
external open class ZoneRules {
    ...
    open fun validOffsets(localDateTime: LocalDateTime): Array<ZoneOffset> = definedExternally
    open fun transition(localDateTime: LocalDateTime): ZoneOffsetTransition = definedExternally
    open fun standardOffset(instant: Instant): ZoneOffset = definedExternally
    open fun daylightSavings(instant: Instant): Duration = definedExternally
    open fun isDaylightSavings(instant: Instant): Boolean = definedExternally
    open fun isValidOffset(localDateTime: LocalDateTime, offset: ZoneOffset): Boolean = definedExternally
    open fun nextTransition(instant: Instant): ZoneOffsetTransition = definedExternally
    open fun previousTransition(instant: Instant): ZoneOffsetTransition = definedExternally
    open fun transitions(): Array<ZoneOffsetTransition> = definedExternally
    open fun transitionRules(): Array<ZoneOffsetTransitionRule> = definedExternally
    override fun toString(): String = definedExternally
    companion object {
...
external open class TextStyle {
    ...
    companion object {
        var FULL: TextStyle = definedExternally
        var FULL_STANDALONE: TextStyle = definedExternally
        var SHORT: TextStyle = definedExternally
        var SHORT_STANDALONE: TextStyle = definedExternally
        var NARROW: TextStyle = definedExternally
        var NARROW_STANDALONE: TextStyle = definedExternally
    }
}
...
external open class ZoneRulesProvider {
    companion object {
        fun getRules(zoneId: String): ZoneRules = definedExternally
        fun getAvailableZoneIds(): Array<String> = definedExternally
    }
}
//external open class DateTimeException(message: String? = definedExternally /* null */) : Error
